...
(cl:defmethod cl:initialize-instance :after ((m <GPS>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GPS)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name serialPort-msg:<GPS> is deprecated: use serialPort-msg:GPS instead.")))

(cl:ensure-generic-function 'lat-val :lambda-list '(m))
(cl:defmethod lat-val ((m <GPS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serialPort-msg:lat-val is deprecated.  Use serialPort-msg:lat instead.")
  (lat m))

(cl:ensure-generic-function 'lon-val :lambda-list '(m))
(cl:defmethod lon-val ((m <GPS>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader serialPort-msg:lon-val is deprecated.  Use serialPort-msg:lon instead.")
  (lon m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<GPS>)))
  ...
  (cl:format cl:nil "float32 lat~%float32 lon~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'GPS)))
  "Returns full string definition for message of type 'GPS"
  (cl:format cl:nil "float32 lat~%float32 lon~%~%~%"))
